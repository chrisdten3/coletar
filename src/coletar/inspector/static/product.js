...
const brand =
  '<a class="brand" href="#/home"><svg class="coletar-symbol" viewBox="0 0 40 40" fill="none" aria-hidden="true"><path d="M29 9a14 14 0 1 0 0 22M29 15a7 7 0 1 0 0 10" stroke="currentColor" stroke-width="5"/><circle cx="31" cy="20" r="3" fill="currentColor"/></svg>coleta</a>';
