...
function horizonHome() {
  ...
  return `<div class="horizon">${horizonNav(true)}<main id="content" class="horizon-main">
    ...
    ${productOfferings()}
    <section id="how-it-works" class="horizon-section truth-section" aria-labelledby="truth-title">
      <div class="truth-heading"><div><span class="section-label">THE STORY BEHIND A MEMORY</span><h2 id="truth-title">Your AI’s source<br>of truth.</h2></div><p>A useful detail has a past.<br> See where it came from, what changed,<br> and which version matters now.</p></div>
      <ol class="truth-steps">
        <li><span class="truth-step-label">01 / THE SOURCE</span><h3>It starts with your words.</h3><div class="truth-card"><div class="truth-card-top">${icon("file")}<span>Project Atlas · Planning</span></div><blockquote>“Let’s launch on 10 October.”</blockquote><div class="truth-card-bottom"><span>Your conversation</span><span>1 September</span></div></div><p>The original conversation gives a saved detail its context.</p></li>
        <li><span class="truth-step-label">02 / THE CHANGE</span><h3>Plans change. History stays.</h3><div class="truth-card"><div class="truth-card-top">${icon("audit")}<span>Launch date · Revision</span></div><div class="truth-revision"><span><small>Previous</small><s>10 October</s></span><span aria-hidden="true">${icon("arrow")}</span><span><small>Updated</small><strong>24 October</strong></span></div><div class="truth-card-bottom"><span>Your correction</span><span>8 September</span></div></div><p>A correction replaces the old detail while preserving what it used to say.</p></li>
        <li><span class="truth-step-label">03 / THE CURRENT MEMORY</span><h3>One clear version to build on.</h3><div class="truth-card truth-card-current"><div class="truth-card-top">${icon("check")}<span>Project Atlas</span><span class="truth-current-label">Current</span></div><p class="truth-memory">Launch is set for<br><strong>24 October.</strong></p><div class="truth-card-bottom"><span>Source preserved</span><span>History retained</span></div></div><p>The current version can inform future work. The earlier date stays in history.</p></li>
      </ol>
      <p class="truth-caption">Illustrative memory history · Project Atlas</p>
    </section>
    ...
    <section class="horizon-faq horizon-section"><div><span class="section-label">A FEW THINGS WORTH KNOWING</span><h2>Clarity,<br>before anything.</h2><a href="#/security">Our boundaries ${icon("external")}</a></div><div class="faq-list">${[
      ...
      .join("")}</div></section>
    <section class="horizon-closing"><a class="btn" href="${ctaHref()}">${ctaLabel()} ${icon("arrow")}</a></section>
