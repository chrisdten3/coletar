...
function horizonHome() {
  ...
  return `<div class="horizon">${horizonNav(true)}<main id="content" class="horizon-main">
    ...
    <section id="how-it-works" class="horizon-section flow-section"><div class="horizon-section-head"><span class="section-label">01 / COLLECT. CONNECT. CONTINUE.</span><h2>Your AI’s<br>source of truth.</h2></div><div id="horizon-flow" class="horizon-flow">${flowPreview()}</div></section>
